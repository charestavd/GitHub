...
import com.example.github.Search.Detail.Fragment.FollowingViewModel
...
class FollowingFragment : Fragment(R.layout.fragment_follow){
    ...
    private lateinit var ModelView: FollowingViewModel
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        ModelView.setListFollowing(username)
        ModelView.getListFollowing().observe(viewLifecycleOwner) {
            if (it != null) {
